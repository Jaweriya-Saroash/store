...
function dataPath(kind='data') {
  if(kind === 'orders') return env('GITHUB_ORDERS_PATH','orders.json'); if(kind === 'customers') return env('GITHUB_CUSTOMERS_PATH','customers.json'); return env('GITHUB_DATA_PATH','site-data.json');
}
